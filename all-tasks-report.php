                    ...
                    <div class="card-content">
                        ...
                        <table class="responsive-table">
                            ...
                            <tbody>
                                ...
                                $get_task_report_query = "SELECT * FROM reporting WHERE employee_id = '$employee_id'";
                                ...
                                while($row = mysqli_fetch_assoc($get_task_report)){
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="task-details.php?task-id=<?php  echo $task_id;?>&emp=<?php echo $employee_id; ?>"><?php echo $task_title; ?></a></td>
