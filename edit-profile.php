                      ...
                      <div class="card-content ">
                           ...
                           <div class="row">
                            ...
                            <?php 
                                    ...
                                    $get_employee_details_query = "SELECT * from employee_details WHERE official_email='$employee_email' ";
                            ...
                            <form class="col s12" method="POST" action="process/edit-profile-process.php">
