...
?>
								...
								if($task_status=="done"){
									echo "<div class='right-align col s6' style='color:green; font-size: 20px;'><p>Task is done</p></div>";

								}else{
									
									echo '<form class="col s12" method="POST" action="process/task-done-process.php?task-id='.$task_id.'">
