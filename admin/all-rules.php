					...
					<div class="card">
						<div class="card-content">
							...
							<table class="responsive-table">
								...
								<tbody>
								<?php
									$get_all_rules_query = "SELECT * FROM official_rules";
                                        ...
                                        while($row = mysqli_fetch_assoc($get_all_rules)){
                                            ...
                                            <tr>
                                                <td><?php echo $id; ?></td>
                                                <td><?php echo $en_title; ?></td>
                                                <td><a href="rule-details.php?rule-id=<?php echo $rule_id; ?>"> View Details </a>
                                                </td>
                                                <td><a href="edit-rule.php?rule-id=<?php echo $rule_id; ?>"> Edit Rule </a>
                                                </td>
                                            </tr>
