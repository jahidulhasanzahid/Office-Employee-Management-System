                    ...
                    <div class="card-content">
                        ...
                        <table class="responsive-table">
                            ...
                            <tbody>
                                ...
                                $get_task_report_query = " SELECT reporting.re_id,reporting.employee_id,reporting.task_create_date,reporting.employee_id,reporting.task_title,reporting.report_status,reporting.task_status,employee_details.id, employee_details.employee_name FROM reporting INNER JOIN employee_details ON reporting.employee_id = employee_details.id ";
