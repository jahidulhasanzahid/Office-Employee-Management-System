				...
				<div class="s12 m6 l4 offset-8 offset-m3">
					<div class="card white darken-1">
						<div class="card-content ">
							...
							<div class="row">
								<form class="col s12" method="POST" action="process/create-official-rule-process.php">
									<div class="input-field col s12">
										<input id="name" type="text" class="validate" name="en_title">
										<label for="employee_name" >Title in English </label>
									</div>
									<div class="input-field col s12">
										<input id="name" type="text" class="validate" name="en_details">
										<label for="email" > Details in English  </label>
									</div>
									<div class="input-field col s12">
										<input id="name" type="text" class="validate" name="bn_title">
										<label for="email" >Title in Bengali </label>
									</div>
									<div class="input-field col s12">
										<input id="name" type="text" class="validate" name="bn_details">
										<label for="email" >Details in Bengali </label>
									</div>
										...
										<div class="col s12 right-align m-t-sm">
											<button href="" class="waves-effect waves-light btn teal" name="create_rule">Create Rule</button>
										</div>
									</form>
								</div>
							</div>
