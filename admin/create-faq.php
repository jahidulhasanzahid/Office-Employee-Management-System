				...
				<div class="s12 m6 l4 offset-8 offset-m3">
					<div class="card white darken-1">
						<div class="card-content ">
							...
							<div class="row">
								<form class="col s12" method="POST" action="process/create-faq-process.php">
									<div class="input-field col s12">
										<input id="name" type="text" class="validate" name="faq_q">
										<label for="employee_name" >Question </label>
									</div>
									<div class="input-field col s12">
										<input id="name" type="text" class="validate" name="faq_a">
										<label for="email" > Answer </label>
									</div>

										<div class="col s12 right-align m-t-sm">
											<button href="" class="waves-effect waves-light btn teal" name="create_faq">Create FAQ</button>
										</div>
									</form>
								</div>
							</div>
