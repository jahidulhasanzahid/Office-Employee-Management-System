              ...
              <div class="col s12 ">
                      ...
                      <div class="card white darken-1">
                          <div class="card-content ">
                              <span class="card-title" align="center">Add section<hr/></span>
                              <div class="row">
                               <form class="col s12" method="POST" action="process/admin-add-section-process.php">
                                   <div class="input-field col s12">
                                       <input id="hdate" type="text" name="section_name" class="">
                                       <label for="add_position" >Section name</label>
                                   </div>
                                   <div class="input-field col s12">
                                   ...
                                   <div class="col s12 right-align m-t-sm">
                                       ...
                                       <center><button href="" class="waves-effect waves-light btn teal" name="add_section">Add</button></center>
                                   </div>
                               </form>
                           </div>
                       </div>
